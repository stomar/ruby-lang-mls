...
describe MLS::StatsHandler do
  ...
  it "can increment a non-existing entry for today" do
    ...
    @stats.entries.last.must_match /2010-01-01,0,1/
  end

  it "can return all entries in correct order" do
    @stats.entries.size.must_equal 3
    @stats.entries[0].must_match /date,talk_subsc/
    @stats.entries[1].must_match /2000-01-01,7/
    @stats.entries[2].must_match /2000-01-02,4/
  end
end
