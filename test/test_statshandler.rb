...
describe MLS::StatsHandler do
  ...
  it "can increment a non-existing entry for today" do
    ...
    _(@stats.entries.last.to_s).must_match "2010-01-01,0,1"
  end
